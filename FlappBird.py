...
IMAGENS_CANO = pygame.transform.scale2x(pygame.image.load(os.path.join('imgs','pipe.png')))
...
class Cano:
    ...
    def __init__(self, x):
        ...
        self.pos_topo =0
        self.pos_base = 0
        self.CANO_TOPO = pygame.transform.flip(IMAGENS_CANO, False, True)
        self.CANO_BASE = IMAGENS_CANO
        self.passou =  False
        self.definir_altura()
    ...
    def colidir(self, passaro):
        passaro_mask = passaro.get_masck()
...
class Chao:
    ...
    def mover(self):
        ...
        if self.chao1 + self.LARGURA <0:
            self.chao1 = self.chao2 + self.LARGURA
...
def desenhar_tela(tela, passaros, canos, chao, pontos):
    ...
    tela.blit(texto,(TELA_ALTURA - 310 - texto.get_width(),10))
